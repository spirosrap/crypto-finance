                ...
                if not self.is_trading_allowed():
                    if not hasattr(self, '_trading_paused_logged'):
                        if current_time.weekday() >= 5:
                            ...
                            self.queue.put(("append", "\nTrading paused: Current time is outside trading hours (6:00 PM - 14:00 PM Greece time) / (10:00 AM - 7:00 AM NYSE time). Will resume at 6:00 PM (Greece time) / 11:00 AM (NYSE time).\n"))
                    ...
                    if hasattr(self, '_trading_paused_logged'):
                        ...
                        self.queue.put(("append", "\nTrading resumed: Current time is within trading hours (6:00 PM - 14:00 PM).\n"))
