...
def analyze(df: pd.DataFrame, ta: TechnicalAnalysis, product_id: str):
    ...
    # Check if RSI was below threshold on previous bar and is now above threshold (confirmation)
    rsi_confirmation = rsi_previous < RSI_THRESHOLD and rsi_current > RSI_THRESHOLD
