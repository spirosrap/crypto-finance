# Crypto Finance — Legacy Documentation

This file archives detailed setup steps and legacy tool documentation that are no longer part of the current pipeline README.
