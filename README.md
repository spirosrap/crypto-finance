...
- **Paper Trade Updater (cron)**: `paper_finder_simulator.py update` runs on a 10-minute cron to keep paper P/L and expiries fresh; logs to `logs/paper_finder_update.log`.
