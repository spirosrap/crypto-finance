...
def parse_arguments():
    ...
    parser.add_argument("--year", type=int, help="Specify a year for backtesting (e.g., 2024)")
...
def run_backtest(trader, args, initial_balance, risk_per_trade, trailing_stop_percent, granularity):
    ...
    if args.year:
        ...
        end_date = datetime(args.year + 1, 1, 1) - timedelta(seconds=1)
...
def main():
    ...
    trailing_stop_percent = 0.087 # 8.7% trailing stop # WAS 0.08
