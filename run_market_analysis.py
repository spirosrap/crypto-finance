...
def run_market_analysis(product_id="BTC-USDC", granularity="ONE_HOUR"):
    ...
    append_text = """====  \n \n Reply only with: BUY AT <PRICE> and SELL AT <PRICE> with STOP LOSS at <PRICE>. Probability of success: <PROBABILITY>. Signal Confidence: <CONFIDENCE>. R/R: <R/R_RATIO>. or SELL AT <PRICE> and BUY BACK AT <PRICE> with STOP LOSS at <PRICE>. Probability of success: <PROBABILITY>. Signal Confidence: <CONFIDENCE>. R/R: <R/R_RATIO>. Instruction 1: Use code to calculate the R/R ratio. Instruction 2: Signal confidence should be between Very Strong, Strong, Moderate, Weak, Very Weak"""
